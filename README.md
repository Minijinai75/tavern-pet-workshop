...
- 【酒館桌寵】離線 ZIP：<https://github.com/Minijinai75/resident-loader/releases/download/v0.3.2/resident-loader-v0.3.2.zip>
...
- Loader v0.3.2 的擴充欄只保留快捷入口；完整設定、日期軸信紙來信與四色番外留言板各自獨立開啟，紀錄可下載 TXT，三種生成可分別勾選角色目前使用的常駐世界書條目。
